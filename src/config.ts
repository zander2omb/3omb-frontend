...
//   },
  ...
  // },
  //                                                             REBATE SECTION 
  Tomb_2SHARES_Rebates: {
    name: 'Convert 2SHARES, earn 3OMB',
    poolId: 0,
    sectionInUI: 3,
  ...
  Tomb_USDC_Rebates: {
      ...
      earnTokenName: '3OMB',
      finished: false,
      multiplier: '20% Distribution',
      buyLink: '',
      site: '',
      sort: 4,
      closedForStaking: false,
    },
  Tomb_2omb_LP_rebates: {
      name: 'Convert 2OMB-LP, earn 3OMB',
      poolId: 3,
      sectionInUI: 3,
      contract: 'TombFtmRewardPool',
      depositTokenName: "2OMB-WFTM LP",
    ...
    Tomb_WFTM_rebates: {
      name: 'Convert FTM, earn 3OMB',
      poolId: 4,
      sectionInUI: 3,
      contract: 'TombFtmRewardPool',
      depositTokenName: "FTM | WFTM",
      earnTokenName: '3OMB',
      finished: false,
      multiplier: '15% Distribution',
      buyLink: '',
  ...
  //   earnTokenName: '3OMB',
  //   finished: false,
  //   multiplier: '% of Reward Distribution',
  //   buyLink: '',
  //   site: '',
  //   sort: 4,
  //   closedForStaking: false,
